...
public class AdminProductAPIController {
	 ...
	 * 
	 */
	@ApiOperation(value="상품 등록", notes="상품 등록API")
	@ApiImplicitParams({
		@ApiImplicitParam(name="productVo",value="상품 정보들",required=true,dataType="query",defaultValue=""),
	})
	 ...
	 *  - no 값이 있으면 -> 상품 상세보기 
	 */
	@ApiOperation(value="상품 목록 조회", notes="상품 목록 조회 API")
	@ApiImplicitParams({
		@ApiImplicitParam(name="no",value="상품 번호",required=false,dataType="query",defaultValue=""),
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name="no",value="상품 번호",required=true,dataType="query",defaultValue="")
	})
