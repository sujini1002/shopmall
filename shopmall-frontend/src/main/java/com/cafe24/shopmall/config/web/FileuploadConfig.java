package com.cafe24.shopmall.config.web;
...
@Configuration
@EnableWebMvc
@PropertySource("classpath:com/cafe24/shopmall/web/properties/multipart.properties")
public class FileuploadConfig extends WebMvcConfigurerAdapter{
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("/assets/images/**").addResourceLocations("file:/shopmall-uploads/");
	}
